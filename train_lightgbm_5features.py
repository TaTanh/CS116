"""
Train LightGBM with 5 features (X1-X5)
- Baseline + Recency & Frequency
...
print("="*70)
print("TRAIN LIGHTGBM - 5 FEATURES")
print("="*70)
...
# Feature columns - 5 features (baseline + recency & frequency)
feature_cols = [
    'X1_brand_cnt_hist',
...
model_path = f"outputs/models/model_lightgbm_5features_{timestamp}.pkl"
predictions_path = f"outputs/predictions/predictions_lightgbm_5features_{timestamp}.parquet"
metrics_path = f"outputs/metrics_lightgbm_5features_{timestamp}.json"
