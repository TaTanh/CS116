"""
Train LightGBM with 3 baseline features (X1, X2, X3)
- Teacher's original features
...
print("="*70)
print("TRAIN LIGHTGBM - 3 FEATURES BASELINE")
print("="*70)
...
# Feature columns - 3 baseline features
feature_cols = [
    'X1_brand_cnt_hist',
...
model_path = f"outputs/models/model_lightgbm_3features_{timestamp}.pkl"
predictions_path = f"outputs/predictions/predictions_lightgbm_3features_{timestamp}.parquet"
metrics_path = f"outputs/metrics_lightgbm_3features_{timestamp}.json"
...
print("\n" + "="*70)
print("DONE - 3 FEATURES BASELINE")
print("="*70)
